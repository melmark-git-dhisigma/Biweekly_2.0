...
public class ClsAccSheetExport
{
    ...
    public DataTable getAccSheet(int StudentId, int SchoolId,string dateToLoad) //Query to Export the Academic Coversheet
    {
        ...
        try
        {
            ...
            "StdtAcdSheet.PersonResNdDeadline,StdtAcdSheet.NoOfTimes1,StdtAcdSheet.NoOfTimes2,StdtAcdSheet.NoOfTimes3,StdtAcdSheet.NoOfTimes4,StdtAcdSheet.NoOfTimes5,StdtAcdSheet.NoOfTimes6,StdtAcdSheet.NoOfTimes7,StdtAcdSheet.LessonPlanId,ISNULL((SELECT TOP 1 LessonOrder FROM DSTempHdr WHERE DSTempHdr.LessonPlanId=StdtAcdSheet.LessonPlanId AND DSTempHdr.StudentId=" + StudentId + "),0) as LessonOrder " +
