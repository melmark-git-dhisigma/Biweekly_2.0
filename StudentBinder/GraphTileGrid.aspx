...
<head runat="server">
    ...
    <script> 
        ...
        function PopupTimeCycleChart() { window.parent.setName1(9); }
        function PopupSteptrial() { window.parent.setName1(10); }
        function PopupBlockschedule() { window.parent.setName1(11); }
...
<body>
    ...
    <table id = "GraphGrid" style="margin-left:210px; margin-top:50px">
	    ...
	    <tr>
             <td><div><asp:LinkButton ID="Timecycle" runat="server" CommandName="9" OnClick="loadgraphMenu"><img src="images/Timecycle.png" alt="Time-Cycle-Charts"  border="0" style="width:180px;height:180px;"/></asp:LinkButton></div></td>
            ...
            <td><div><asp:LinkButton ID="Progress_Summary_Clinical" runat="server" CommandName="7" OnClick="loadgraphMenu"><img src="images/ProgressSummay_Clinical.jpg" alt="Progress_Summary_clinical"  border="0" style="width:180px;height:180px;"/></asp:LinkButton></div></td>
		      <td><div><asp:LinkButton ID="StepTrial" runat="server" CommandName="10" OnClick="loadgraphMenu"><img src="images/Steptrial.png"  alt="Step/Trial"  border="0" style="width:180px;height:180px;"/></asp:LinkButton></div></td>
        ...
        <tr>
          <td><div><asp:LinkButton ID="Blockschedule" runat="server" CommandName="11" OnClick="loadgraphMenu"><img src="images/Blockschedule.png"  alt="Block Schedule"  border="0" style="width:180px;height:180px;"/></asp:LinkButton></div></td>
