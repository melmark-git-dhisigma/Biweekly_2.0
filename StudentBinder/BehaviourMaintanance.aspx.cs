...
public partial class StudentBinder_BehaviourMaintanance : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        sess = (clsSession)Session["UserSession"];
        curesesid = this.Session.SessionID.ToString();
        Pagepath = "CustomizeTemplateEditor:LoadData";
        sess = clsGeneral.sessioncheck(curesesid, preid, preuser, sess, Prevsess, SessStudentid, Sessstname, Pagepath);
        objData = new clsData();
    ...
    protected void btnSubmitIEP1_Click(object sender, EventArgs e)
    {
        ...
        sess = (clsSession)Session["UserSession"];
        curesesid = this.Session.SessionID.ToString();
        Pagepath = "CustomizeTemplateEditor:btnSubmitIEP1_Click";
        sess = clsGeneral.sessioncheck(curesesid, preid, preuser, sess, Prevsess, SessStudentid, Sessstname, Pagepath);
        objData = new clsData();
    ...
    protected string SaveGoal(string goalid, bool flag)
    {
        try
        {
            ...
            curesesid = this.Session.SessionID.ToString();
            Pagepath = "CustomizeTemplateEditor:SaveGoal";
    ...
    protected void EnableAllAlerts(int MeasurementId)
    {
        ...
        sess = (clsSession)Session["UserSession"];
        curesesid = this.Session.SessionID.ToString();
        Pagepath = "CustomizeTemplateEditor:EnableAllAlerts";
        sess = clsGeneral.sessioncheck(curesesid, preid, preuser, sess, Prevsess, SessStudentid, Sessstname, Pagepath);
