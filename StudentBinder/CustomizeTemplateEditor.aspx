                                ...
                                <h3 class="cf" style="margin:0 0 0 10px;float:none">
                                    ...
                                    <asp:Panel runat="server" ID="panelButtons">
                                        <span style="float: right; margin: -20px 0 0 23px;" class="spnClass">
                                            ...
                                            <asp:Button ID="BtnEmail" runat="server" class="NFButton" Text="Email for review" Visible="false" Style="Width:110px;margin: 8px 10px 0 0; float: left;" title="Email review" OnClick="LoadEmail_Click" OnClientClick="loadEmailOrder(this.id);return false;"/>
                                            ...
                                            <div style="display: none;" class="wrapper nomar">
                                                <div class="nobdrrcontainer">
                                                    <asp:DataList ID="dlLP" runat="server" OnItemDataBound="dlLP_ItemDataBound">
                                                        <HeaderTemplate><div style="background-color:#80ccff;color:#0D668E;font-weight:bold;text-align:center;vertical-align:middle">In-progress</div></HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:DataList ID="dlLPMailed" runat="server" OnItemDataBound="dlLPMailedItemDataBound">
                                                        <HeaderTemplate><div style="background-color:#80ccff;color:#0D668E;font-weight:bold;text-align:center;vertical-align:middle">In-progress - emailed for review</div></HeaderTemplate>
                                                        <ItemTemplate>
