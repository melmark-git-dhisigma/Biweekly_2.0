...
public partial class StudentBinder_SupportStrategyAttributes : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (sess != null)
            {
                if (sess.SchoolId == 1)
                {
                    ...
                    objVal = objData.FetchValue(strQuery);
                    tdIEPDate.InnerHtml = "<b>ISP Dates: </b>" + objVal;
    ...
    private void FillLessonDetails(string LessonId, string TempId)
    {
        ...
        if (sess != null)
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                tdLesson.InnerHtml = "<b>Title: </b>" + Dt.Rows[0]["LessonPlanName"].ToString();
                ...
                tdMaterials.InnerHtml = "<b>MATERIALS(all items needed + their location): </b>" + Dt.Rows[0]["Materials"].ToString();
            }
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                tdLessonDelivary.InnerHtml = "<b>Delivery Instructions:</b>" + Dt.Rows[0]["LessonDefInst"].ToString();
                ...
                tdMajorSet.InnerHtml = "<b>SETTING:</b>" + Dt.Rows[0]["MajorSetting"].ToString() + "</br>" + Dt.Rows[0]["MinorSetting"].ToString();
    ...
    private void FillMeasurement(string TempId)
    {
        ...
        if (sess != null)
        {
            ...
            tdMeasurement.InnerHtml = "<b>MEASUREMENT SYSTEM: </b>" + strBinder.ToString() + "</ul>";
        }
        else
        {
            tdMsg.InnerHtml = clsGeneral.warningMsg("Session Expired...Please login again");
    ...
    private void fillDataLEssonPlan(int LessonPlanId, int TempId)
    {
        ...
        if (sess != null)
        {
            ...
            if (Dt != null)
            {
                foreach (DataRow Dr in Dt.Rows)
                {
                    strBinder += "<w:br/>" + Dr["ColTypeCd"].ToString();
                }
            }
