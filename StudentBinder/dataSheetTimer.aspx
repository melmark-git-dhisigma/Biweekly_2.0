        ...
        function saveYesOrNo(inputBtn, thisElem) {
                    ...
                    $.ajax(
            {
                            ...
                            success: function (data) {
                                    ...
                                    if (data.d == "Invalid Event Time") {
                                        var alertBox = "<div class='alertBox' style='height:20px; border:1px solid black; text-align:center; font-weight:bold; padding:3px; position: relative; background-color:red; top:10px;'>Invalid Event Time.</div>";
                        ...
                        $.ajax(
                        {
                            ...
                            success: function (data) {
                                ...
                                var contents = data.d;
                                    ...
                                    if (contents == "Invalid Event Time") {
                                        var alertBox = "<div class='alertBox' style='height:20px; border:1px solid black; text-align:center; font-weight:bold; padding:3px; position: relative; background-color:red; top:10px;'>Invalid Event Time.</div>";
