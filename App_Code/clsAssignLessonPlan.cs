        ...
        try
        {
            ...
            if (flag == true)
            {
                ...
                else if (TId == 0)
                {
                    ...
                    strQuery = "INSERT INTO DSTempHdr(SchoolId,StudentId,LessonPlanId,StdtLessonplanId,DSTemplateName,BaselineStart,BaselineEnd,VTLessonId,[CompCurrInd],MultiStepInd,NoofTimesTried," +
                               ...
                               "'" + StdtLesPlanId + "','" + LessonName + "',BaselineStart,BaselineEnd,VTLessonId,[CompCurrInd],MultiStepInd,NoofTimesTried,MultiSetsInd,CurrVerInd,VerBeginDate,VerEndDate," +
            ...
            else
            {
                ...
                if (HttpContext.Current.Session["Baseline"] != null && HttpContext.Current.Session["Objective"] != null)
                {
                    ...
                    basProce = clsGeneral.convertQuotes(basProce);
                    gObject = clsGeneral.convertQuotes(gObject);
                }
